                ...
                <Modal
                    ...
                    <Modal.Footer className='V_modal_header mx-auto pb-4'>
                        <div className="d-flex justify-content-center">
                            ...
                            <button className='ds_sub_cancel' onClick={() => setAddHomeLabelJoinModal(false)}>Clear</button>
                        </div>
                    </Modal.Footer>
                </Modal>
            </div>
            ...
            <div className=''>
                <Modal
                    ...
                    <Modal.Footer className='V_modal_header mx-auto pb-4'>
                        <div className="d-flex justify-content-center">
                            <button className='ds_role_save'>Save</button>
                            <button className='ds_sub_cancel' onClick={() => setEditHomeLabelJoinModal(false)}>Clear</button>
                        </div>
                    </Modal.Footer>
                </Modal>
            </div>
