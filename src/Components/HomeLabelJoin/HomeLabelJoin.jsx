    ...
    <>
      <section className='V_outlet_back text-white pt-3 px-3 pt-lg-5 px-lg-5'>
        <div className="d-flex justify-content-between">
          <div>
            <h1 className='V_title'>Home Label Join</h1>
            <p><span className='V_his_first'>Dashboard</span> / <span className='V_his_second'> Home Label Join</span></p>
          </div>
          <div className='align-self-center'>
            <button className='V_add_button bg-white text-black py-2 px-sm-4  ' onClick={() => navigate('/layout/addhomelabeljoin')}>
              <FaPlus />     Add
            </button>
          </div>
        </div>
            ...
            <table className=" text-white">
              <thead className='V_border_bottom'>
                <tr >
                  ...
                  <th className='V_thead'>Home Label ID</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className='V_thead'>9632</td>
                  <td className='V_thead'>2541211</td>
                  <td className='V_thead'>
                    <div className="d-flex justify-content-center">
                      <div>
                        <img src={require('../../Images/Parth/edit_button.png')} alt="" className='V_action_image' onClick={() => navigate("/layout/edithomelabeljoin")} />
                      </div>
                      <div>
