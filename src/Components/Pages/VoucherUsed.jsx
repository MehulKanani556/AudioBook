                    ...
                    <Modal.Header className='V_modal_header'>
                        <Modal.Title id="contained-modal-title-vcenter" className='px-lg-5 w-100' >
                            <div className="d-flex justify-content-between ">
                                ...
                                <div className='ms-auto' onClick={() => setAddVoucherUsedModal(false)}>
                                    <img src={Close} alt="" />
                                </div>
                            </div>
                        </Modal.Title>
                    ...
                    <Modal.Header className='V_modal_header'>
                        <Modal.Title id="contained-modal-title-vcenter" className='px-lg-5 w-100' >
                            <div className="d-flex justify-content-between ">
                                ...
                                <div className='ms-auto' onClick={() => setEditVoucherUsedModal(false)}>
                                    <img src={Close} alt="" />
                                </div>
                            </div>
                        </Modal.Title>
            ...
            <Modal show={removeVoucherUsed} onHide={() => setRemoveVoucherUsed(false)} size="md" aria-labelledby="contained-modal-title-vcenter " className='text-light ds_role_delete_modal' centered>
                ...
                <Modal.Body >
                    <div className='text-center'>
                        ...
                        <p className='ds_role_text'>Are you sure you want to delete Voucher Used?</p>
                        <div className='mt-5 mb-5'>
                            <button className='ds_delete_cancel' onClick={() => setRemoveVoucherUsed(false)}>Cancel</button>
