                ...
                <div className='ds_dash_main'>
                    <div className='ds_dash_inner'>
                        <div className='d-flex justify-content-between align-items-center'>
                            ...
                            <div>
                                <button className='V_review_btn' onClick={() => setAddPlaylistMasterModal(true)}><i className="fa-solid fa-plus me-2"></i> Add</button>
                            </div>
                        </div>
                                ...
                                <table className='w-100 text-light V_review_table  text-nowrap '>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Lorem Ipsum</td>
                                            <td className=''>
                                                <span className=' me-2 ds_cursor' onClick={() => setEditPlaylistMasterModal(true)}>
                                                    <img src={pen} alt="" />
                                                </span>
                                                <span className='ds_cursor' onClick={() => setRemovePlaylistMaster(true)}>
                                                    <img src={trash} alt="" />
                                                </span>
                                            </td>
                                        </tr>
