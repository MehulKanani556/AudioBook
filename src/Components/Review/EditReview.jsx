    ...
    return (
        <>
            <section className='V_outlet_back text-white pt-3 px-3 pt-lg-5 px-lg-5'>
                <h1 className='V_title px-3'>Edit Review</h1>
                ...
                <div className="row pt-2 py-5">
                    ...
                    <div className="col-12 col-sm-6 col-md-12 col-lg-6 mt-3 px-4">
                        <label htmlFor="" className='V_label'>User ID</label>
                        <input type="text" className='V_add_input border-0 mt-2' />
                    </div>
                    <div className="col-12 col-sm-6 col-md-12 col-lg-6 mt-3 px-4">
                        <label htmlFor="" className='V_label'>Date</label>
                        <input type="text" className='V_add_input border-0 mt-2' />
                    </div>
                    <div className="col-12 col-sm-6 col-md-12 col-lg-6 mt-3 px-4">
                        <label htmlFor="" className='V_label'>Review</label>
                        <input type="text" className='V_add_input border-0 mt-2' />
                    </div>
                    <div className="col-12 col-sm-6 col-md-12 col-lg-6 mt-3 px-4">
                        <label htmlFor="" className='V_label'>Rating</label>
                        <input type="text" className='V_add_input border-0 mt-2' />
                    </div>
                </div>
